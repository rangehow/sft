...
CUDA_VISIBLE_DEVICES=1 python special_train.py --gradient_accumulation_steps 512 --total_bsz 512 --zero_prob 0 --div_mode True --weighted True --dataset alpaca_gpt4 --mix True --mix_ratio 0.8&
CUDA_VISIBLE_DEVICES=2 python special_train.py --gradient_accumulation_steps 512 --total_bsz 512 --zero_prob 0 --div_mode False --weighted True --dataset alpaca_gpt4 --mix True --mix_ratio 0.8&
CUDA_VISIBLE_DEVICES=3 python special_train.py --gradient_accumulation_steps 512 --total_bsz 512 --zero_prob 0 --div_mode False --dataset alpaca_gpt4 --mix True --mix_ratio 0.8&