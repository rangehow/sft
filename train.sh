...
CUDA_VISIBLE_DEVICES=3 python special_train.py --gradient_accumulation_steps 512 --total_bsz 512 --zero_prob 0 --alpha 0.5 --div_mode True --weighted False --dataset alpaca_gpt4,code,math&
