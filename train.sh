...
CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node 2 special_train.py --gradient_accumulation_steps 32 --total_bsz 256 --zero_prob 0 --div_mode False --weighted False --dataset alpaca_gpt4 --mix True --mix_ratio 0.5&