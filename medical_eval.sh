...
python -m sft.eval.gsm8k  --mode 0 --shot --dp --dataset medical,medmcqa --model /niutrans/NEUNLP/rjh/sft/naive_mistral_med_pt_medquad_7m28d_bsz256_cosine_lr2e-05_template_warmratio5e-02 --output_path  fuck
