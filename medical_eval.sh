...
python -m sft.eval.gsm8k  --mode 0 --shot --dp --dataset medical,medmcqa --model /niutrans/NEUNLP/rjh/sft/naive_qwen2_7b_textbooks_7m28d_bsz256_cosine_lr3e-04_warmratio5e-02 --output_path  fuck
