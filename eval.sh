...
CUDA_VISIBLE_DEVICES=2,3 python -m sft.eval.gsm8k --dataset gsm8k --model /data/ruanjh/best_training_method/output522/checkpoint-6470 --vllm --mode 0 --shot 



CUDA_VISIBLE_DEVICES=1 python -m sft.eval.gsm8k --model model_output/522weighted --dataset gsm8k --vllm --mode 0 --shot &
