...
CUDA_VISIBLE_DEVICES=1,3 python -m sft.eval.gsm8k --dataset gsm8k --model /data/ruanjh/best_training_method/output522  --vllm --mode 0 --shot 



CUDA_VISIBLE_DEVICES=1,2,3  python -m sft.eval.gsm8k   --vllm --mode 0 --shot --dp --dataset mmlu --model sft/smile
...
python -m sft.eval.gsm8k --model /data/ruanjh/best_training_method/gemma-2b --dataset truthfulqa --vllm --mode 0 --logprob --shot  
